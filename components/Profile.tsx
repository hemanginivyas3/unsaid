  ...
  return (
    <div className="space-y-8 fade-in">
      <div className="bg-white rounded-[2.5rem] p-8 border border-aura-100 shadow-sm text-center">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          <div className="bg-aura-50 p-4 rounded-2xl border border-aura-100">
            <div className="text-2xl font-serif text-aura-800">
              {user.streak}
            </div>
            <div className="text-[10px] font-bold text-aura-400 uppercase tracking-tighter">
              Day Streak
            </div>
          </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-8 border border-aura-100 shadow-sm">
        <h3 className="text-xl font-serif text-aura-800 mb-4 italic">
          About Unsaid
        </h3>

        <p className="text-aura-600 leading-relaxed font-serif text-lg mb-4">
          Unsaid was built to be a safe, private vault for your soul. Unlike
          social media, there are no likes, no followers, and no judgments.
        </p>

        {/* ✅ PRIVACY SAFE TEXT */}
        <p className="text-aura-500 text-sm leading-relaxed">
          Your entries are stored only on your device. Unsaid does not store
          your personal writing in any database — so even the creator cannot
          read it.
        </p>
